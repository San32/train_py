...
class Recognition:
     def ExtractNumber(self):
         ...
         #to find number plate measureing length between rectangles
          ...
          result = pytesseract.image_to_string(Image.open('er_plate.jpg'), lang='Hangul')
...
# print(pytesseract.image_to_string(Image.open('er_plate.jpg'), lang='Hangul'))
# print(pytesseract.image_to_string(Image.open('plate_th.jpg'), lang='Hangul'))
